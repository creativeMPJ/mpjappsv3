...
const pusatChildren: RouteObject[] = [
  ...
  { path: "militansi/leveling", element: <PusatPengaturanLevelingPage /> },
  { path: "pengaturan", element: <PusatPengaturanOverviewPage /> },
  { path: "pengaturan/profil", element: <PusatPengaturanProfilPage /> },
  { path: "pengaturan/tim-pusat", element: <PusatPengaturanTimPusatPage /> },
  ...
  { path: "pengaturan/leveling", element: <Navigate to="/pusat/militansi/leveling" replace /> },
  { path: "pengaturan/harga-sku", element: <PusatPengaturanHargaSkuPage /> },
  { path: "pengaturan/paket-slot", element: <Navigate to="/pusat/pengaturan/harga-sku" replace /> },
  { path: "pengaturan/admin-role", element: <Navigate to="/pusat/pengaturan/tim-pusat" replace /> },
