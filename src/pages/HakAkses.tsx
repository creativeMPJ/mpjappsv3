...
// ─── Menu Groups — dikelompokkan per role agar tidak rancu ──────────────────
const menuGroups = [
  {
    id: "admin-media",
    label: "Admin Media (Pengguna Pesantren)",
    icon: IdCard,
    items: [
      { id: "identitas",  label: "Profil Pesantren", icon: IdCard },
      { id: "pembayaran", label: "Administrasi",      icon: ClipboardList },
      { id: "tim",        label: "Kelola Crew",        icon: Users },
      { id: "eid",        label: "E-ID Card",          icon: ImageIcon },
  ...
  },
  {
    ...
    items: [
      { id: "eid",        label: "E-ID Card",    icon: ImageIcon },
      { id: "tim",        label: "Lihat Kru",    icon: Users },
      { id: "militansi",  label: "Militansi XP", icon: Swords },
      { id: "user-event", label: "Event",         icon: CalendarDays },
      { id: "hub",        label: "MPJ Hub",       icon: Globe },
    ],
  },
  {
    ...
    icon: Map,
    items: [
      { id: "validasi-pendaftar",             label: "Verifikasi Pendaftar", icon: UserCheck },
      { id: "data-master",                    label: "Data Regional",         icon: BarChart3 },
      ...
      { id: "admin-regional-manajemen-event", label: "Kelola Event",          icon: CalendarDays },
      { id: "hub",                            label: "MPJ Hub",               icon: Globe },
    ],
  },
  {
    ...
    icon: Shield,
    items: [
      { id: "administrasi",                 label: "Verifikasi & Administrasi", icon: ClipboardList },
      { id: "master-data",                  label: "Master Data",               icon: BarChart3 },
      { id: "master-regional",              label: "Master Regional",           icon: Map },
      { id: "admin-pusat-manajemen-event",  label: "Master Event",              icon: CalendarDays },
      { id: "militansi",                    label: "Manajemen Militansi",       icon: Swords },
      { id: "mpj-hub",                      label: "MPJ Hub (Pusat)",           icon: Globe },
      { id: "hub",                          label: "MPJ Hub",                   icon: Globe },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { id: "laporan-keuangan",    label: "Laporan Keuangan",      icon: FileText },
      { id: "harga",               label: "Pengaturan Harga",      icon: Banknote },
