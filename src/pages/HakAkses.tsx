...
// ─── Menu Groups (per fitur/modul, bukan per role) ────────────────────────────
const menuGroups = [
  {
    id: "dashboard",
    label: "Dashboard",
    ...
    items: [
      { label: "Dashboard", path: "/cms/dashboard", icon: Home },
    ],
  },
  {
    id: "identitas",
    ...
    icon: Building2,
    items: [
      { label: "Identitas Pesantren", path: "/cms/identitas-pesantren", icon: Building2 },
      { label: "Profil Lembaga", path: "/cms/profil-lembaga", icon: ClipboardCheck },
    ],
  },
  {
    id: "kru",
    ...
    icon: Users,
    items: [
      { label: "Daftar Kru", path: "/cms/kru-daftar", icon: Users },
      { label: "EID Aset", path: "/cms/kru-eid", icon: IdCard },
    ],
  },
  {
    id: "event",
    ...
    icon: Calendar,
    items: [
      { label: "Daftar Event", path: "/cms/event-daftar", icon: Calendar },
      { label: "Laporan Event", path: "/cms/event-laporan", icon: FileText },
    ],
  },
  {
    id: "verifikasi",
    ...
    icon: CheckCircle,
    items: [
      { label: "Verifikasi Pendaftar", path: "/cms/verifikasi-pendaftar", icon: CheckCircle },
      { label: "Verifikasi Pembayaran", path: "/cms/verifikasi-pembayaran", icon: DollarSign },
    ],
  },
  {
    id: "keuangan",
    ...
    icon: DollarSign,
    items: [
      { label: "Laporan Keuangan", path: "/cms/keuangan-laporan", icon: BarChart2 },
      { label: "Harga & Paket", path: "/cms/keuangan-harga", icon: Tags },
      { label: "Clearing House", path: "/cms/keuangan-clearing", icon: RefreshCw },
      { label: "Monitoring Regional", path: "/cms/keuangan-monitoring", icon: Activity },
    ],
  },
  {
    id: "master",
    ...
    icon: Database,
    items: [
      { label: "Data Pesantren", path: "/cms/master-pesantren", icon: Building2 },
      { label: "Data Regional", path: "/cms/master-regional", icon: Map },
      { label: "Data Kota/Kabupaten", path: "/cms/master-kota", icon: Map },
    ],
  },
  {
    id: "hub",
    ...
    icon: Share2,
    items: [
      { label: "MPJ Hub", path: "/cms/mpj-hub", icon: Share2 },
      { label: "Kolaborasi", path: "/cms/hub-kolaborasi", icon: Layers },
    ],
  },
  {
    id: "user-management",
    ...
    icon: Users,
    items: [
      { label: "Daftar User", path: "/cms/user-management", icon: Users },
      { label: "Audit Log", path: "/cms/audit-log", icon: FileText },
      { label: "Hierarki Data", path: "/cms/hierarki", icon: Layers },
    ],
  },
  {
    id: "pengaturan",
    ...
    icon: Settings,
    items: [
      { label: "Hak Akses", path: "/cms/hak-akses", icon: Shield },
      { label: "Pengaturan Sistem", path: "/cms/pengaturan-sistem", icon: Settings },
    ],
  },
  {
    id: "publik",
    ...
    icon: Globe,
    items: [
      { label: "Direktori", path: "/direktori", icon: Database },
      { label: "Profil Pesantren", path: "/pesantren/:nip", icon: Building2 },
      { label: "Profil Crew", path: "/pesantren/:nip/crew/:niamSuffix", icon: IdCard },
    ],
  },
];
...
const dummyHakAkses: HakAksesItem[] = [
  {
    ...
    nama: "Admin Pusat",
    role: "admin_pusat",
    permissions: "/cms/dashboard:read, /cms/identitas-pesantren:read, /cms/master-pesantren:read, /cms/master-pesantren:create, /cms/master-pesantren:update, /cms/master-regional:read, /cms/event-daftar:read, /cms/event-daftar:create, /direktori:read",
  ...
  },
  {
    ...
    nama: "Admin Regional",
    role: "admin_regional",
    permissions: "/cms/dashboard:read, /cms/verifikasi-pendaftar:read, /cms/verifikasi-pendaftar:update, /cms/master-pesantren:read, /cms/master-regional:read, /cms/event-daftar:read, /direktori:read",
    created_at: new Date().toISOString(),
  },
  {
    id: "3",
    nama: "Admin Finance",
    role: "admin_finance",
    permissions: "/cms/dashboard:read, /cms/verifikasi-pembayaran:read, /cms/verifikasi-pembayaran:update, /cms/keuangan-laporan:read, /cms/keuangan-harga:read, /cms/keuangan-harga:update, /cms/keuangan-clearing:read, /cms/keuangan-monitoring:read",
    created_at: new Date().toISOString(),
  },
  {
    id: "4",
    ...
    role: "user",
    permissions: "/cms/dashboard:read, /cms/identitas-pesantren:read, /cms/identitas-pesantren:update, /cms/profil-lembaga:read, /cms/kru-daftar:read, /cms/kru-daftar:create, /cms/kru-daftar:update, /cms/kru-eid:read, /cms/event-daftar:read, /cms/mpj-hub:read, /direktori:read",
    created_at: new Date().toISOString(),
  },
  {
    id: "5",
    nama: "Super Admin",
    role: "super_admin",
    permissions: "/cms/dashboard:read, /cms/user-management:read, /cms/user-management:create, /cms/user-management:update, /cms/user-management:delete, /cms/hierarki:read, /cms/audit-log:read, /cms/hak-akses:read, /cms/hak-akses:create, /cms/hak-akses:update, /cms/hak-akses:delete, /cms/pengaturan-sistem:read, /cms/pengaturan-sistem:update",
    created_at: new Date().toISOString(),
  },
];
...
const HakAkses = () => {
  ...
  const collectPermissions = (): string => {
    ...
    allMenuItems.forEach((item) => {
      CRUD_ACTIONS.forEach((action) => {
        if (formData.permissions[`${item.path}_${action}`]) {
          perms.push(`${item.path}:${action}`);
        }
      });
    });
    return perms.join(", ");
  ...
  const parsePermissionsToFormState = (permStr: string) => {
    ...
    perms.forEach((perm) => {
      ...
      if (allMenuItems.find((m) => m.path === path) && action) {
        next[`${path}_${action}`] = true;
      }
    });
    allMenuItems.forEach((item) => {
      if (CRUD_ACTIONS.every((a) => next[`${item.path}_${a}`])) {
        next[`${item.path}_all`] = true;
      }
    });
    return next;
  };
